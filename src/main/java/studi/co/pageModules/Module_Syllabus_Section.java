...
public class Module_Syllabus_Section extends BaseClass{
	...
	public void toVerify_The_Available_Resource_Of_The_BookShelf() throws Exception {
		...
		//List<MobileElement> books=getDriver().findElementsById("com.tce.studi:id/tv_book_name");
	...
	public void toVerify_User_Should_Be_Shown_Completed_In_School_Status() throws Exception {
		...
		//		WebElement topic=getDriver().findElementById("com.tce.studi:id/tvChapter");

		//	MobileElement LessonPanel1 = getDriver().findElementByXPath("//*[contains(@text, '1. The Earth in the Solar System')]/parent::*/following-sibling::androidx.recyclerview.widget.RecyclerView");
		...
		if(status) {
			...
			System.out.println("\"Completed in School\" Status is shown to the user for those particular chapter of a book which has been marked Completed by User");
			test.log(Status.INFO, "\"Completed in School\" Status is shown to the user for those particular chapter of a book which has been marked Completed by User");
	...
	public void toVerify_User_Should_Be_Shown_Excluded_From_Syllabus_Status() throws Exception {
		...
		if(status) {
			...
			System.out.println("\"Excluded from Syllabus\" Status is shown to the user for those particular chapter of a book,which is excluded from the users curriculum OR by marking it Excluded manually");
			test.log(Status.INFO, "\"Excluded from Syllabus\" Status is shown to the user for those particular chapter of a book,which is excluded from the users curriculum OR by marking it Excluded manually");

		}
	}


	public void toVerify_User_Should_Able_To_Mark_The_Chapter_As_Completed_In_School_Manually(String subject,String topic) throws Exception {
	...
	public void toVerify_User_Should_Able_To_Mark_The_Chapter_As_Excluded_From_Syllabus_Manually(String subject,String topic) throws Exception {
		...
		if(status) {
			...
			System.out.println("\"Excluded from Syllabus\" Status is shown to the user for those particular chapter of a book which has been marked Completed by User");
			test.log(Status.INFO, "\"Excluded from Syllabus\" Status is shown to the user for those particular chapter of a book which has been marked Completed by User");
	...
	public void toVerify_User_Should_Able_To_Mark_The_TPs_As_Completed_In_School_Manually(String subject,
	...
	public void toVerify_User_Should_Be_Shown_Low_Confidence_Status_For_The_Tp_In_Which_User_Has_Scored_Low_Confidence(
		...
		if(status) {
			...
			System.out.println("Low Confidence Status is shown to the user for those particular TP for which user has scored Low Confidence");
			test.log(Status.INFO, "Low Confidence Status is shown to the user for those particular TP for which user has scored Low Confidence");
		}
		assert1.assertTrue(status);
		assert1.assertAll();
	...
	public void toVerify_User_Should_Be_Shown_High_Confidence_Status_For_The_Tp_In_Which_User_Has_Scored_Low_Confidence(
		...
		if(status) {
			...
			test.log(Status.INFO, "High Confidence Status is shown to the user for those particular TP for which user has scored High Confidence");
		}
		assert1.assertTrue(status);
		assert1.assertAll();
	...
	public void toVerify_User_Should_Be_Shown_Medium_Confidence_Status_For_The_Tp_In_Which_User_Has_Scored_Low_Confidence(
		...
		if(status) {
			...
			System.out.println("Medium Confidence Status is shown to the user for those particular TP for which user has scored Medium Confidence");
			test.log(Status.INFO, "Medium Confidence Status is shown to the user for those particular TP for which user has scored Medium Confidence");
		}
		assert1.assertTrue(status);
		assert1.assertAll();
