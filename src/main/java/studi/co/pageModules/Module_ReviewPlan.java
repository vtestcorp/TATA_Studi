...
//		
//		for(MobileElement testUnit : testUnitList) {
//			testUnit.click();
//			Thread.sleep(5000);
//			scrollTo2("Plan Details");
//			String subjectName=orp.subjectNameAtReviewPlanPage.getText();
//			Boolean progressbar=orp.progressBar.isDisplayed();
//			if(progressbar) {
...
//		Thread.sleep(3000);
//		for (int i = 0; i < 2; i++) {
//			applyExplicitWaitsUntilElementVisible(orp.nextMonthButton);
//			orp.nextMonthButton.click();
//			applyExplicitWait(5);
//			
//		}
...
//		orp.checkBox1.click();
//		orp.checkBox2.click();
//		List <MobileElement> checkBoxes=getDriver().findElementsByClassName("android.widget.CheckBox");
//		MobileElement check = null;
...
//		}
		...
		orp.addToPortion.click();
		applyExplicitWait(5);
//		Boolean verify1=orp.addToPortionMessage.isDisplayed();
//		if(verify1) {
//			System.out.println("User can Update Portions to the Plan");
//			test.log(Status.INFO, "User can Update Portions to the Plan");
//
//		}
//		assert1.assertTrue(verify1);
	...
	public void toVerify_Activation_ofModifiedPortion_ToThePlan() throws MalformedURLException, InterruptedException {
		...
		orp.addToPortion.click();
		applyExplicitWait(5);
//		Boolean verify=orp.addToPortionMessage.isDisplayed();
//		if(verify) {
//			System.out.println("User can Add Portions to the Plan");
//			test.log(Status.INFO, "User can Add Portions to the Plan");
//		}
//		assert1.assertTrue(verify);
//		
		orp.nextStep.click();
