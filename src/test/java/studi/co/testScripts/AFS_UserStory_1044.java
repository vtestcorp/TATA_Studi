...
public class AFS_UserStory_1044 extends BaseClass {
	...
	@Test(enabled = true, groups = "NewUser") 
	void TC06_Verify_Create_Study_Plan_Button_Is_Tappable_On_Landing_Page()
			throws MalformedURLException, InterruptedException {
		Module_Create_Study_Plan csp = new Module_Create_Study_Plan();
	...
	//	Required lessons which are planned in past
	@Test(enabled = true, groups = "ExistingUser")//failed :MobileElement LessonPanel1 = getDriver().findElementByXPath("//*[contains(@text, 'Today')]/parent::*/ancestor::androidx.recyclerview.widget.RecyclerView");
