...
public class Assignment_Oral_Test  extends BaseClass {
	...
	@Test(enabled = false)//change topic 
	public void TC09_To_Verify_that_User_Should_be_able_to_Add_the_Content_Even_if_Striked_off_for_Creating_Oral_Test() throws MalformedURLException, InterruptedException {
		Module_Assignment_Oral_Test  maot=new Module_Assignment_Oral_Test();
		maot.to_verify_that_user_should_be_able_to_add_the_Content_even_if_striked_off_for_creating_oral_test(prop.getProperty("subject"),prop.getProperty("topic_1"));
	}
	@Test(enabled = false)
	...
	@Test(enabled = false)//pass
	public void TC12_To_rify_for_select_Deselect_of_chapters_and_Topics() throws MalformedURLException, InterruptedException {
		Module_Assignment_Oral_Test  maot=new Module_Assignment_Oral_Test();
	...
	@Test(enabled = false)//pass_update
	...
	public void TC27_Verify_with_blank_Title() throws MalformedURLException, InterruptedException {
		Module_Assignment_Oral_Test  maot=new Module_Assignment_Oral_Test();
		maot.to_verify__with_blank_Title(prop.getProperty("subject"),prop.getProperty("topic_1"));
	}
	@Test(enabled = false)//pass
	...
	@Test(enabled = false)//On page layout contents should be display Chapter Name , Topics name and videos related to selected Topics  
	...
	public void TC35_To_verify_Begin_test() throws MalformedURLException{
		Module_Assignment_Oral_Test  maot=new Module_Assignment_Oral_Test();
		maot.to_verify_he_begin_test(prop.getProperty("subject"),prop.getProperty("topic_1"));
	}

	@Test(enabled = false)// correct answer  highlighted in green color
	...
	@Test(enabled = false,priority=-3)//pass
	...
	public void TC46_To_verify_that_submit_Test_successfully() throws MalformedURLException, InterruptedException{ 
		Module_Assignment_Oral_Test  maot=new Module_Assignment_Oral_Test();
		maot.to_verify_the_Verify_that_submit_test_successfully(prop.getProperty("subject"),prop.getProperty("topic_1"));
	}

	@Test(enabled = false)
	public void TC47_To_verify_after_submi_oral_test_there_should_not_be_any_scoring_critria() throws MalformedURLException, InterruptedException{ 
		Module_Assignment_Oral_Test  maot=new Module_Assignment_Oral_Test();
	...
	@Test(enabled = false)
	public void TC48_To_verify_the_Preview_functionality() throws MalformedURLException, InterruptedException{ 
		Module_Assignment_Oral_Test  maot=new Module_Assignment_Oral_Test();
		maot.to_verify_the_Preview_functionality(prop.getProperty("subject"),prop.getProperty("topic_1"));
	}
	@Test(enabled = false)
	public void TC49_To_verify_user_should_be_able_to_preview_of_the_Oral_Test() throws MalformedURLException, InterruptedException{ 
		Module_Assignment_Oral_Test  maot=new Module_Assignment_Oral_Test();
		maot.to_verify_user_should_be_able_to_preview_of_the_Oral_Test(prop.getProperty("subject"),prop.getProperty("topic_1"));
	}
	@AfterMethod
