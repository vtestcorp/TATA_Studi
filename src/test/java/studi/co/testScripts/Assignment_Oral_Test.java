...
public class Assignment_Oral_Test  extends BaseClass {
	...
	@Test(enabled = false)//Hold-Correct button displayed with happy face emoticon and in green color
	...
	@Test(enabled = false)//Hold Partial Correct button displayed  with Normal face emoticon and Orange color
	...
	@Test(enabled = false)//Hold Incorrect button displayed  with sad face emoticon with pink color
