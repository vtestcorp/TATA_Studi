...
public class BrowseBook_Resource_Listing extends BaseClass {
	...
	public void TC_07_To_Verify_User_should_be_shown_Not_Accessed_Status_when_user_has_not_started_that_particular_chapter() throws Exception {
		Module_BrowseBook_Resource_Listing  msic =new Module_BrowseBook_Resource_Listing();
		msic.to_verify_user_should_be_shown_Not_Accessed_Status_when_user_has_not_started_that_particular_chapter(prop.getProperty("subject_eng"),prop.getProperty("topic_eng2"));
	}
	@Test(enabled = true)//pass
	public void TC_09_To_Verify_User_should_be_shown_Low_Confidence_Status_for_the_chapter_in_which_user_has_scored_Low_Confidence() throws Exception {
		Module_BrowseBook_Resource_Listing  msic =new Module_BrowseBook_Resource_Listing();
		msic.to_verify_User_should_be_shown_Low_Confidence_Status_for_the_chapter_in_which_user_has_scored_Low_Confidence(prop.getProperty("subject_eng"),prop.getProperty("topic_eng"));
	}
	@Test(enabled = true)//pass
	public void TC_10_To_Verify_User_should_be_shown_medium_Confidence_Status_for_the_chapter_in_which_user_has_scored_Low_Confidence() throws Exception {
		Module_BrowseBook_Resource_Listing  msic =new Module_BrowseBook_Resource_Listing();
		msic.to_verify_User_should_be_shown_medium_Confidence_Status_for_the_chapter_in_which_user_has_scored_Low_Confidence(prop.getProperty("subject_eng"),prop.getProperty("topic_eng"));
	}
	@Test(enabled = true)//pass
	public void TC_11_To_Verify_User_should_be_shown_Hign_Confidence_Status_for_the_chapter_in_which_user_has_scored_Low_Confidence() throws Exception {
		Module_BrowseBook_Resource_Listing  msic =new Module_BrowseBook_Resource_Listing();
		msic.to_verify_User_should_be_shown_High_Confidence_Status_for_the_chapter_in_which_user_has_scored_Low_Confidence(prop.getProperty("subject_eng"),prop.getProperty("topic_eng"));
	}
	@Test(enabled = true)//pass
