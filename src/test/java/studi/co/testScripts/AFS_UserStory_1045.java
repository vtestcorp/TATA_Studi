...
public class AFS_UserStory_1045 extends BaseClass{
	...
	@Test(enabled=false)   //Not Completed(Need changes in app)
	...
	@Test(enabled=false)  //Not Completed(Need changes in app)
	public void T18_To_Verify_User_Should_Not_Shown_Any_Colour_Code_Schema_In_Upcoming_Tab() throws Exception {
		Module_MyLesson_Page mmp=new Module_MyLesson_Page();
		mmp.toVerify_User_Should_Not_Shown_Any_Colour_Code_Schema_In_Upcoming_Tab();
	}
